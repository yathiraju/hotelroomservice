package com.hotel.room.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("hotelroomservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("hotelroomservice");
        ...
        config.getMapConfigs().put("com.hotel.room.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
